...
class User implements UserInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=CookingExpertise::class, inversedBy="users")
     * @ORM\JoinColumn(nullable=false)
     */
    private $cookingExpertise;
    ...
    public function getCookingExpertise(): ?CookingExpertise
    {
        return $this->cookingExpertise;
    }

    public function setCookingExpertise(?CookingExpertise $cookingExpertise): self
    {
